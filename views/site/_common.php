...
/*
 * common ads site/view
 */
?>

<div id="common-block" class="ads-container">
        <h2>Похожие объявления</h2>
        <ul class="row">
            <?php
                // вывод объявлений из БД
                // $model_common выводит из site/view.php

                foreach ($model_common as $ads):
                    if (!empty($ads->photo1))
                        {
                    ...
                    . '<div class="ads-block ads-common">'
