...
<aside id="aside-right" class="col-md-3">
        <div id="vip-block" class="ads-container row">
                ...
                <?php
                    ...
                    // $model_aside выводит из category/index.php
        ...
        <div class="banners">
            <img src="images/banners/avdeev.jpg" alt="Баннер в VIP-блоке 1" width="100%" class="img-responsive">
            <img src="images/banners/jevelry-shop-lombard.jpg" alt="Баннер в VIP-блоке 2" width="100%" class="img-responsive">
            <img src="images/banners/kansk-trikitaj.jpg" alt="Баннер в VIP-блоке 3" width="100%" class="img-responsive">
